...
export const createValidTCModel = (gvl?: GVL): TCModel => {
  ...
  // full consent!
  tcModel.setAll(); // Todo: will throw error if no GVL
  ...
  tcModel.publisherCustomConsents.set(12);
  ...
  tcModel.publisherRestrictions.add(12, new PurposeRestriction(7, RestrictionType.NOT_ALLOWED));
  tcModel.publisherRestrictions.add(13, new PurposeRestriction(7, RestrictionType.NOT_ALLOWED));
