import {sameDataDiffRef} from '@internaltestiabtechlab/testing';
...
describe('TCModel', (): void => {
  ...
  const testInstanceOf = <T>(fieldName: string, theInstanceOf: {new (): T}): void => {
    ...
    describe(fieldName, (): void => {
      ...
      const gvl: GVL = new GVL(require('@internaltestiabtechlab/testing/lib/vendorlist/vendor-list.json'));
