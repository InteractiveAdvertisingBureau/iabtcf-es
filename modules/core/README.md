[![NPM version](https://img.shields.io/npm/v/@cookiehub/iabtcf-core.svg?style=flat-square)](https://www.npmjs.com/package/@cookiehub/iabtcf-core)
[![npm module downloads per month](http://img.shields.io/npm/dm/@cookiehub/iabtcf-core.svg?style=flat)](https://www.npmjs.org/package/@cookiehub/iabtcf-core)
[![InteractiveAdvertisingBureau](https://circleci.com/gh/InteractiveAdvertisingBureau/iabtcf-es.svg?style=shield)](https://circleci.com/gh/InteractiveAdvertisingBureau/iabtcf-es)

# @cookiehub/iabtcf-core
...
npm
```
npm install @cookiehub/iabtcf-core --save
```

yarn
```
yarn add @cookiehub/iabtcf-core
```
...
```javascript
import {TCModel, TCString, GVL} from '@cookiehub/iabtcf-core';
...
```javascript
import {TCModel} from '@cookiehub/iabtcf-core';
...
import {TCModel, PurposeRestriction, RestrictionType} from '@cookiehub/iabtcf-core';
...
```typescript
import {TCString, TCModel, GVL} from '@cookiehub/iabtcf-core';
...
import {TCString, Segment} from '@cookiehub/iabtcf-core';
